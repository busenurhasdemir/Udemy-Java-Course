public class Test {// has-a ilişkisi var
    ...
    public static void main(String[] args) {
        ...
        //kasa.bilgisayari_ac();
        //pc.kasa.bilgisayari_ac(); böyle yazabilmek için bilgisayar classındaki kasa public olmalı
        pc.getMonitor().monitoru_kapat();
        pc.getAnakart().isletim_sistemi_yukle("Ubuntu 16.4");
