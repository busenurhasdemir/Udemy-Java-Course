public class Idman {
    ...
    public void burpeeYap(int sayi){
        ...
        if ((burpee_sayisi-sayi)<0){
            System.out.println("Hedeflediğin burpee sayısına ulaştın. Tebrikler!...");
            burpee_sayisi=0;
    ...
    public void pushupYap(int sayi){
        ...
        if ((pushup_sayisi-sayi)<0){
            System.out.println("Hedeflediğin pushup sayısına ulaştın. Tebrikler!...");
            pushup_sayisi=0;
    ...
    public void situpYap(int sayi){
        ...
        if ((situp_sayisi-sayi)<0){
            System.out.println("Hedeflediğin situp sayısına ulaştın. Tebrikler!...");
            situp_sayisi=0;
    ...
    public void squatYap(int sayi){
        ...
        if ((squat_sayisi-sayi)<0){
            System.out.println("Hedeflediğin squat sayısına ulaştın. Tebrikler!...");
            squat_sayisi=0;
