...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Hayvan classında oluşturduğumuz bir referansı başka class için de kullanabiliriz
        //eğr bir method subclassta yoksa superclasstaki kullanılır yani kedide konus olmasaydı hayvanınkini kullanacaktı
        /*
        ...
        */
        ...
        if (kopek instanceof Kopek){
            System.out.println("Bu nese köpek sınıfından...");
        }
        if (kopek instanceof Hayvan){
            System.out.println("Bu nesne köpek sınıfından...");
        }
        //burada Kopek Hayvanın subclassı olduğu için oldu ama Hayvan yerine Kedi yazsaydık olmazdı
        */
